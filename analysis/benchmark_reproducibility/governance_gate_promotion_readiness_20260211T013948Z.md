...
- Window days: 14
- Window start (UTC): 2026-01-28T01:39:48Z
- Min drill samples: 3
...
- Drill artifacts in window: 3 (pass=3, pass_rate=100.00%)
- Handoff artifacts in window: 4 (blocked=0)
- Breach route artifacts in window: 2 (breach_detected=0, would_block=0)
...
|---|---:|---|---|
| `drill_sample_sufficient` | 3 | >= 3 | yes |
...
| `latest_breach_route_present` | yes | pass | analysis/benchmark_reproducibility/monitor_drift_breach_route_20260211T013948Z.json |
| `latest_handoff_present` | yes | pass | analysis/benchmark_reproducibility/monitor_drift_release_handoff_20260211T013948Z.json |
| `latest_drill_present` | yes | pass | analysis/benchmark_reproducibility/monitor_drift_release_readiness_drill_20260211T013948Z.json |
