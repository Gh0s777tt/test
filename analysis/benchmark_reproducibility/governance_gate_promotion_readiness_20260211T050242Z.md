...
- Window days: 14
- Window start (UTC): 2026-01-28T05:02:42Z
- Min drill samples: 3
...
- Drill artifacts in window: 4 (pass=4, pass_rate=100.00%)
- Handoff artifacts in window: 5 (blocked=0)
- Breach route artifacts in window: 3 (breach_detected=0, would_block=0)
...
|---|---:|---|---|
| `drill_sample_sufficient` | 4 | >= 3 | yes |
...
| `latest_breach_route_present` | yes | pass | analysis/benchmark_reproducibility/monitor_drift_breach_route_20260211T050242Z.json |
| `latest_handoff_present` | yes | pass | analysis/benchmark_reproducibility/monitor_drift_release_handoff_20260211T050242Z.json |
| `latest_drill_present` | yes | pass | analysis/benchmark_reproducibility/monitor_drift_release_readiness_drill_20260211T050242Z.json |
