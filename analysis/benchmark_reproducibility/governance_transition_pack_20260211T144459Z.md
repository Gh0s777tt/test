...
| signoff_validation_md | `analysis/benchmark_reproducibility/monpol_signoff_validation_20260211T142342Z.md` | yes |
| signoff_validation_json | `analysis/benchmark_reproducibility/monpol_signoff_validation_20260211T142342Z.json` | yes |
...
| promotion_readiness_md | `analysis/benchmark_reproducibility/governance_gate_promotion_readiness_20260211T144459Z.md` | yes |
| promotion_readiness_json | `analysis/benchmark_reproducibility/governance_gate_promotion_readiness_20260211T144459Z.json` | yes |
| enforced_pilot_runbook_md | `analysis/benchmark_reproducibility/enforced_pilot_runbook_20260211T144459Z.md` | yes |
| enforced_pilot_runbook_json | `analysis/benchmark_reproducibility/enforced_pilot_runbook_20260211T144459Z.json` | yes |
| enforced_pilot_burn_in_md | `analysis/benchmark_reproducibility/enforced_pilot_burn_in_slo_20260211T144459Z.md` | yes |
| enforced_pilot_burn_in_json | `analysis/benchmark_reproducibility/enforced_pilot_burn_in_slo_20260211T144459Z.json` | yes |
| rollback_postmortem_md | `analysis/benchmark_reproducibility/enforced_pilot_rollback_postmortem_20260211T144459Z.md` | yes |
| rollback_postmortem_json | `analysis/benchmark_reproducibility/enforced_pilot_rollback_postmortem_20260211T144459Z.json` | yes |
| handoff_signoff_packet_md | `analysis/benchmark_reproducibility/enforced_pilot_handoff_signoff_packet_20260211T144459Z.md` | yes |
| handoff_signoff_packet_json | `analysis/benchmark_reproducibility/enforced_pilot_handoff_signoff_packet_20260211T144459Z.json` | yes |
...
- Burn-in artifact: `analysis/benchmark_reproducibility/enforced_pilot_burn_in_slo_20260211T144459Z.json`
- Generated at (UTC): 2026-02-11T14:44:59Z
- Burn-in overall status: **pass**
- Window artifacts: 5, samples=3, safe_rate_pct=100.0
- rollback_recommendations=0, guardrail_breach_events=0, preflight_failures=0

| Criterion | Passed | Value | Target |
|---|---|---:|---|
| `samples_sufficient` | yes | 3 | >= 1 |
...
- Signoff packet artifact: `analysis/benchmark_reproducibility/enforced_pilot_handoff_signoff_packet_20260211T144459Z.json`
- Generated at (UTC): 2026-02-11T14:44:59Z
- Closure required: `no`
