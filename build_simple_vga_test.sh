...
# VantisOS v0.5.0 - Simple VGA Test Build Script

set -e

echo "Building VantisOS v0.5.0 Simple VGA Test..."
...
rustc --target x86_64-unknown-none --crate-type lib --edition 2021 \
    ...
    src/verified/v0.5.0_kernel/simple_vga_test.rs -o build/kernel.o 2>&1 | grep -v "warning:"
...
echo ""
echo "To create ISO:"
echo "  bash create_simple_vga_test_iso.sh"
echo ""