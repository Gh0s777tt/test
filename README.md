...
- **v0.5.0 "Real Kernel"** (March 1, 2025): Real kernel with GRUB 2 boot support
- **v0.6.0 "Mobile Ready"** (March 1, 2026): ARM64 kernel, mobile drivers, touch UI
- **v0.7.0 "IoT Ready"** (March 2, 2026): RISC-V support, IoT drivers, power management
...
- **[README](README_v1.0.0.md)** - Project overview and getting started
...
- **[DEVELOPER_GUIDE](DEVELOPER_GUIDE.md)** - Developer documentation
...
- `build_kernel.sh` - Build kernel with optimizations
- `create_test_iso.sh` - Create bootable ISO
- `run_qemu.sh` - Run VantisOS in QEMU
