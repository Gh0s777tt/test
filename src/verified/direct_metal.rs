...
impl GpuDevice {
    ...
    #[cfg_attr(feature = "verus", builtin_macros::verus_spec)]
...
impl GpuMemory {
    ...
    #[cfg_attr(feature = "verus", builtin_macros::verus_spec(ensures(ret.is_ok() ==> ret.unwrap().size() == size)))]
...
impl CommandBuffer {
    ...
    #[cfg_attr(feature = "verus", builtin_macros::verus_spec(requires(self.command_count() > 0)))]
